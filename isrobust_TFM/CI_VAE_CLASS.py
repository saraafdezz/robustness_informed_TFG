...
class InformedVAE:
    def __init__(self, adjacency_matrices,adjacency_names,adjacency_activation, learning_rate=1e-5, seed=42):
        self.adjacency_matrices = adjacency_matrices if isinstance(adjacency_matrices, list) else [adjacency_matrices]
        self.adjacency_names = adjacency_names if isinstance(adjacency_names, list) else [adjacency_names]
        self.adjacency_activation = adjacency_activation if isinstance(adjacency_activation, list) else [adjacency_activation]
    ...
    def _build_vae(self):
        self.layers = []
        for adj,name,act in zip(self.adjacency_matrices,self.adjacency_names,self.adjacency_activation):
